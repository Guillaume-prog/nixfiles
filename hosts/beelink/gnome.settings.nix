...
favorite-apps = ["firefox.desktop" "vesktop.desktop" "code.desktop" "net.lutris.Lutris.desktop" "org.prismlauncher.PrismLauncher.desktop" "obsidian.desktop" "org.gnome.Nautilus.desktop"];
...
folders = {
	...
	"org/gnome/desktop/app-folders/folders/System" = {
		apps=["Alacritty.desktop" "org.gnome.DiskUtility.desktop" "com.mattjakeman.ExtensionManager.desktop" "pavucontrol.desktop" "org.gnome.Settings.desktop" "org.gnome.SystemMonitor.desktop" "org.gnome.tweaks.desktop"];
		name="System";
		translate=false;
	};
